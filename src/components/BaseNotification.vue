...
> = {
  info: {
    container: "bg-info-soft border-info-line",
    icon: "text-info",
    title: "text-info-fg",
    text: "text-info-fg",
  },
  success: {
    container: "bg-success-soft border-success-line",
    icon: "text-success",
    title: "text-success-fg",
    text: "text-success-fg",
  },
  warning: {
    container: "bg-warning-soft border-warning-line",
    icon: "text-warning",
    title: "text-warning-fg",
    text: "text-warning-fg",
  },
  error: {
    container: "bg-danger-soft border-danger-line",
    icon: "text-danger",
